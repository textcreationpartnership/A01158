...
#####Front#####
THE Epitome OF All the Lives OF The French KingsFrom PHARAMOND ye first to the now Regning Lewis the
...
1. An Epitome of all the lives of the Kings of France, from Pharamond their first, to the now Reigning Lewis the 13.
    ...
    _ Clovis 5. King of France, and the first Christian King of that Nation. Anno 485.
...
There are 51 **ommitted** fragments! 
 @__reason__ (51) : foreign (1), illegible: blotted (1), duplicate (49)  •  @__extent__ (50) : 1 word (1), 1 page (49)
...
|---|---|---|
|Latin-1 Supplement|àâèá|224 226 232 225|
...
|2.|__closer__|1||
|3.|__desc__|51||
|4.|__div__|72| @__type__ (72) : frontispiece (1), title_page (1), to_the_reader (1), text (1), part (67), table_of_contents (1)|
|5.|__ex__|3||
|6.|__expan__|3||
|7.|__figDesc__|65||
|8.|__figure__|66||
|9.|__g__|1560| @__ref__ (1560) : char:EOLhyphen (1547), char:abque (3), char:punc (8), char:cmbAbbrStroke (2)|
|10.|__gap__|51| @__reason__ (51) : foreign (1), illegible: blotted (1), duplicate (49)  •  @__extent__ (50) : 1 word (1), 1 page (49)|
|11.|__head__|70||
|12.|__hi__|4255| @__rend__ (1) : sup (1)|
|13.|__item__|65||
|14.|__l__|48||
|15.|__lg__|17||
|16.|__list__|1||
